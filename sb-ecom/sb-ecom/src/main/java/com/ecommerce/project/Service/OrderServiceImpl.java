...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    @Transactional
    public OrderDTO placeOrder(String emailId, Long addressId, String paymentMethod, String pgPaymentId, String pgStatus, String pgName, String pgResponseMessage) {
